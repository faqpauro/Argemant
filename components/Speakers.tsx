...
export default function Speakers() {
  return (
    <section id="speakers" className="py-24 bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-white relative z-10 scroll-mt-32 transition-colors duration-500">
          ...
          {speakers.map((speaker) => (
            ...
            >
              ...
              <div className="relative mb-6">
                ...
                <div className="relative w-[110px] h-[145px] rounded-lg overflow-hidden bg-slate-200 dark:bg-slate-800 shadow-md ring-1 ring-black/5 dark:ring-white/10">
                  <Image 
                    src={speaker.image} 
                    alt={speaker.name}
              ...
              <div className="text-center w-full">
                <h3 className="text-lg font-bold text-slate-855 dark:text-white mb-2 leading-tight group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-300">
                  {speaker.name}
                </h3>
                
                <p className="text-sm text-slate-500 dark:text-slate-400 font-medium mb-4 h-10 flex items-center justify-center">
                  {speaker.role}
                </p>
                
                {/* Chip de Empresa */}
                <div className="inline-block bg-blue-50 dark:bg-blue-950/50 border border-blue-100 dark:border-blue-900/40 text-blue-600 dark:text-cyan-400 text-[11px] font-bold px-4 py-1 rounded-full uppercase tracking-wider">
                  {speaker.company}
                </div>
              </div>
